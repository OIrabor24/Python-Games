...
print(f"Paths between {key} and {value}:", graph_routes.get_paths(key, value))
print(f"Shortest path between {key} and {value}:", graph_routes.get_shortest_paths(key, value))
